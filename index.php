...
<?php include_once 'header.php' ?>
    ...
    <!-- <div class="hero-area position-relative">
        <img src="assets/img/homepage2/hero-img.png" alt="" class="hero-img">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="assets/img/homepage2/banner-2.png" class="d-block w-100" alt="...">
    ...
    <div class="carousel-item">
      <img src="assets/img/homepage2/banner-1.png" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
      <div class="hero-containt">
		 <p>Your health. Our priority.</p>
         <h3>100% pure <br> Pharmacy.</h3>
    ...
    <div class="carousel-item">
      <img src="assets/img/homepage2/banner-3.png" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
      <div class="hero-containt">
		 <p>Your health. Our priority.</p>
         <h3>100% pure <br> Pharmacy.</h3>
  ...
  <button class="carousel-control-next" type="button" data-target="#carouselExampleCaptions" data-slide="next">
    ...
    <div class="product-area">
        <img src="assets/img/homepage2/round-sheap.png" alt="" class="round-sheap">
        <div class="container">
            <div class="row pb-120">
                <div class="col-lg-4 col-md-5" >
                    <div class="single-product not-showing" >
                        <img src="assets/img/homepage2/p1.png" alt="">
                        <h3>Save 20% <br>
                            On Sanitizers</h3>
                        <p>99.9% Germ <br>
                            Protection</p>
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="single-product not-showing" style="background-image: url(assets/img/homepage2/p2-bg.pn)">
                        <img class="single-img-2" src="assets/img/homepage2/p2.png" alt="">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="quality-fl">
                        <div class="quality-text single-product not-showing">
                ...
                <div class="col-lg-6">
                    <div class="qiality-pp">
                        <img src="assets/img/homepage2/pluse-sheap.png" alt="" class="pluse-sheap">
                        <div class="row">
    ...
    <div class="featured-area position-relative">
        <img src="assets/img/homepage2/pluse-2.png" alt="" class="pluse-2">
        <div class="container">
        <div class="search-arrea">
                        <form action="" method="get">
                            <div class="form-group" id='form-div'>
                            <input type="search" name="search" id="search-product" class='form-control' placeholder='Enter any Product detail'>
                            <button class='btn btn-dark searching' type='button'>Search</button>
                            </div>
                        </form>
                    </div>
            <div class="row">
    ...
    <div class="view-area">
        ...
        <div class="container">
		<img src="assets/img/homepage2/round-sheap.png" class="home-slider-circle" alt="circle-shape">
            <div class="row">
                <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="brand-fl">
                        <div class="single-brand">
                            <img src="assets/img/homepage2/b1.png" alt="">
                        </div>
                        <div class="single-brand">
                            <img src="assets/img/homepage2/b2.png" alt="">
                        </div>
                        <div class="single-brand">
                            <img src="assets/img/homepage2/b3.png" alt="">
                        </div>
                        <div class="single-brand">
                            <img src="assets/img/homepage2/b4.png" alt="">
                        </div>
                        <div class="single-brand">
                            <img src="assets/img/homepage2/b5.png" alt="">
                        </div>
                        <div class="single-brand">
                            <img src="assets/img/homepage2/b6.png" alt="">
                        </div>
                        <div class="single-brand">
                            <img src="assets/img/homepage2/b7.png" alt="">
                        </div>
                        <div class="single-brand">
                            <img src="assets/img/homepage2/b8.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
